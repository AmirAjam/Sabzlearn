...
const PrimaryButton = ({ disabled, text, icon ,submit}) => {
    const BtnIcon = icons[icon]
    return (
        <button type={`${submit ? "submit" : "button"}`} className={`bg-green-primary rounded-lg py-3 w-full cursor-pointer text-white
