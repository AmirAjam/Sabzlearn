...
const SubHeadLineItem = () => {
    return (
        <Link className="flex justify-between items-center py-6 border-b border-b-gray-300 dark:border-b-gray-600 hover:text-primary 
            ...
            <div className='flex gap-3 items-center'>
                <span className='flex items-center justify-center rounded-sm w-8 h-6 bg-gray-100 dark:bg-gray-600 text-sm
                 text-gray-600 dark:text-white group-hover/sub:bg-primary duration-200'>
                    12
                </span>
