      ...
      flex-row-reverse items-center justify-center gap-12 lg:px-0">
        ...
        <div className='lg:w-1/2'>
          ...
          <div className='mt-5 lg:mt-10 lg:flex justify-between items-center'>
            {discount ?
              <div className='lg:w-3/4 flex gap-4 items-center'>
                <p className='text-lg dark:text-gray-400 line-through'>{price?.toLocaleString()}</p>
                <p className='text-center mb-5 lg:mb-0 font-Vazirmatn-Bold text-xl lg:text-right
                 lg:text-2xl'>
