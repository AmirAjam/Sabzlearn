        ...
        <section className='mt-8'>
            <div className="container bg-white dark:bg-darker rounded-lg py-4">
                <div className="flex justify-between gap-3 items-center">
                    <div className="flex justify-center items-center flex-col sm:flex-row sm:justify-start sm:gap-5
                     sm:pr-5 bg-gray-100 dark:bg-dark w-1/2 rounded-lg py-3">
                        <icons.Users className="text-primary fill-primary text-4xl" />
                        <div>
                ...
                <div className="mt-8">
                    ...
                    <div className="w-full mt-3 bg-primary/30 dark:bg-primary/10 rounded-full flex justify-end">
                        <span className="bg-primary w-[90%] h-3 block rounded-full"></span>
                    </div>
                </div>
            </div>
        </section>
