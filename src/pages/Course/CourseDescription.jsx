    ...
    return (
        <section>
            <div className="container bg-white dark:bg-darker mt-8 py-5 rounded-lg relative">
                <h2 className='font-Vazirmatn-Bold text-xl'>توضیحات</h2>
                <span className='-right-2 block absolute h-10 w-2 bg-amber-400 top-3 rounded-xs'></span>
                <div className='mt-8'>
                    <img src="/public/images/courses/2.webp" alt="" className='rounded-lg' />
                </div>
                <div className='line-clamp-6 overflow-hidden mt-8 text-justify'>
                    <p>کامپوننت محور بودن ری اکت باعث میشه شما با کدنویسی یک بخش بتونید بی نهایت بار در بخش های مختلف پروژه از اون استفاده کنید و از طرفی میتونید پروژه هایی بسازید که بدون نیاز به رفرش، هر دیتا و بخشی از صفحه رو تغییر بدید اون هم با سرعت نور! برای همین ری اکت، زمان کدنویسی و به اتمام پروژه رو خیلی کوتاهتر از قبل کرده!
                        ...
                        پشتیبانی دوره در سایت بخش پرسش و پاسخ انجام میشه و علاوه بر مدرس، چند نفر کمک پشتیبان مسلط جهت پاسخگویی و رفع مشکلات شما نیز حضور دارند. بنابراین برای رفع مشکلات و جواب سوالات درگیر تیکت و انتظار نمیشید و در سریع ترین زمان ممکن کارتون راه میفته!
                        ...
                        اگه از دانشجوهای قدیمی باشید که میدونید اما اگه جدیدا افتخار میزبانی از شمارو پیدا کردیم، بدونید که هم HTML و هم CSS در سبزلرن دوره رایگان دارن و در واقع مهمون ما هستید برای شروع یک مسیر هیجان انگیز در زندگی حرفه ای خودتون.
                ...
                <div className='w-fit mt-6 mx-auto'>
                    <SeconderyButton text="مشاهده بیشتر مطلب" icon="ArrowDown"/>
                </div>
            </div>
        </section>
    )
