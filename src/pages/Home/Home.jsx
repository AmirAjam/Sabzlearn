    ...
    <>
     ...
     text-white bg-no-repeat bg-cover bg-center lg:pb-10 mb-16">
      ...
      <main>
        <Courses />
        <RoadMap />
        <CourseSlider title="پرطرفدار ترین دوره ها" primaryTitle={"دوره های محبوب و پروژه محور سبزلرن"} />
        <AboutUs />
        <CourseSlider title="جدیدتریــن ها" primaryTitle={"دوره‌های جدید، فرصت‌های نو"} />
        <ArticleSection />
